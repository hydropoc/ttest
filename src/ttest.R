...
get_t_test <- function(start, end) {
    ...
    tryCatch(
        expr = {
            ...
            temperature_water_head <- head(temperature_water, n = (dbGetRowCount(rs)) / 2)
            temperature_water_tail <- tail(temperature_water, n = (dbGetRowCount(rs)) / 2)
            ...
            temperature_air_head <- head(temperature_air, n = (dbGetRowCount(rs)) / 2)
            temperature_air_tail <- tail(temperature_air, n = (dbGetRowCount(rs)) / 2)
            ...
            humidity_head <- head(humidity, n = (dbGetRowCount(rs)) / 2)
            humidity_tail <- tail(humidity, n = (dbGetRowCount(rs)) / 2)
            ...
            co2_level_head <- head(co2_level, n = (dbGetRowCount(rs)) / 2)
            co2_level_tail <- tail(co2_level, n = (dbGetRowCount(rs)) / 2)
            ...
            ph_value_head <- head(ph_value, n = (dbGetRowCount(rs)) / 2)
            ph_value_tail <- tail(ph_value, n = (dbGetRowCount(rs)) / 2)
            ...
            ec_value_head <- head(ec_value, n = (dbGetRowCount(rs)) / 2)
            ec_value_tail <- tail(ec_value, n = (dbGetRowCount(rs)) / 2)
            ...
            swimmer_1_head <- head(swimmer_1, n = (dbGetRowCount(rs)) / 2)
            swimmer_1_tail <- tail(swimmer_1, n = (dbGetRowCount(rs)) / 2)
            ...
            swimmer_2_head <- head(swimmer_2, n = (dbGetRowCount(rs)) / 2)
            swimmer_2_tail <- tail(swimmer_2, n = (dbGetRowCount(rs)) / 2)
            ...
            swimmer_3_head <- head(swimmer_3, n = (dbGetRowCount(rs)) / 2)
            swimmer_3_tail <- tail(swimmer_3, n = (dbGetRowCount(rs)) / 2)
